...
I didn't get a chance to regraph these (so they're not the best - they're the canned graphs from the fit output), but they use the weighted counts and display a catch curve for peak age to the age with the last observation greater than 1. 
